#
# This file was automatically generated by ReFrame based on '/home/oldeman/reframe/settings.py'.  # noqa: E501
#
                    ...
                    'resources': [
                        {
                            'name': 'lgpu',
                            'options': [
                                '--gres=gpu:lgpu:{num_lgpu_per_node}'
                            ]
                        },
                        {
                            'name': 'gpu',
                    ...
                    'resources': [
                        {
                            'name': 'v100',
                            'options': [
                                '--gres=gpu:v100:{num_v100_per_node}'
                            ]
                        },
                        {
                            'name': 'p100',
                            'options': [
                                '--gres=gpu:p100:{num_p100_per_node}'
                            ]
                        },
                        {
                            'name': 't4',
                            'options': [
                                '--gres=gpu:t4:{num_t4_per_node}'
                            ]
                        },
                        {
                            'name': 'gpu',
                    ...
                    'resources': [
                        {
                            'name': 'k20',
                            'options': [
                                '--gres=gpu:k20:{num_k20_per_node}'
                            ]
                        },
                        {
                            'name': 'k80',
                            'options': [
                                '--gres=gpu:k80:{num_k80_per_node}'
                            ]
                        },
                        {
                            'name': 'gpu',
